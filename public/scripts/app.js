  ...
  _createClass(IndecisionApp, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Options, { options: this.state.options, deleteOptions: this.handleDeleteOptions }),
        React.createElement(AddOption, { addOption: this.handleAddOption }),
        React.createElement(Action, { hasOptions: this.state.options.length > 0, pick: this.handlePick })
      );
    }
  }]);
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          'p',
          null,
          'Add option component here. Options length = ',
